...
void main() {
  ...
  eyesWaterColor = vec4(vanillaWaterColor, 0.05);
      ...
      eyesWaterColor.rgb = vec3(0.247 , 0.4627, 0.8941);
    #elif Water_Color_Test == swamp
      eyesWaterColor.rgb = vec3(0.3803, 0.4823, 0.3921);
    #elif Water_Color_Test == frozen_ocean_and_river
      eyesWaterColor.rgb = vec3(0.2235, 0.2196, 0.7882);
    #elif Water_Color_Test == warm_ocean
      eyesWaterColor.rgb = vec3(0.2627, 0.8352, 0.9333);
    #elif Water_Color_Test == lukewarm_ocean
      eyesWaterColor.rgb = vec3(0.2705, 0.6784, 0.949 );
    #elif Water_Color_Test == cold_ocean
      eyesWaterColor.rgb = vec3(0.2392, 0.3411, 0.8392);
    #endif
  #endif
